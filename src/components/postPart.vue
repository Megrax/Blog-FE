<template>
  <section class="body">
    <!-- 博文 -->
    <div class="title" v-bind:style="picStyle(post.ppic)">
      {{ post.ptitle }}
    </div>
    <article>
      <article v-html="post.pcontent"></article>
      <!-- 标签 -->
      <aside>
...
export default {
  ...
  methods: {
    picStyle: function (img) {
      ...
      return {
        background: "url('https://images.unsplash.com/photo-1601690893510-097a654804c2?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=668&q=80') rgba(0, 0, 0, 0.3) center center / 100% no-repeat",
